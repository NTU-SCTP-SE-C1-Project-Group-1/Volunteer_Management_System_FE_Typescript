...
// Type
import { NewProgramType } from '../../../CustomHooks/TypesAndStates';

interface Props {
  form: NewProgramType;
  changeHandler: (e: any) => void;
  onClickToCreateNewProgram: () => void;
}

function NewProgram({ form, changeHandler, onClickToCreateNewProgram }: Props) {
  return (
    <div className="flex flex-col justify-center items-center w-screen md:w-[50vw]">
      ...
      <div className="flex flex-col md:flex-row md:justify-between justify-center items-center mt-5 md:space-x-12 w-[40vw]">
        <div className="flex flex-col mb-2 w-[82vw] md:w-[18vw]">
          <label className="pb-2 font-semibold text-sm" htmlFor="timeOfProgram">
            Time of Program:
          </label>
          <select
            name="timeOfProgram"
